...
try {
    ...
    console.log("Connected to the ASTRO_MD Whatsapp Bot By Maher Zubair")
} catch {
...
setTimeout(() => {
    ...
    global.slogo = 'https://leadier-umbrellas.000webhostapp.com/pic5.jpg'
    global.sgc = 'https://chat.whatsapp.com/CmY0THcJCUYEGxLJulhcRV'
    global.srepo = 'https://github.com/Astropeda/SIGMA-MD'
    global.scap = '*ᴀꜱᴛʀᴏ-ᴍᴅ* '
    global.sgen = `*╰┈➤ 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ${name.botname}*`
    global.snam = 'ᴀꜱᴛʀᴏ-ᴍᴅ'
    global.scate  = `
┏━━⟪⟪ ${mztit} ⟫━⦿       
...
setInterval(() => { store.writeToFile(__dirname+"/store.json"); }, 30 * 1000);
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                var { body } = citel
		        const Zubi = ['2348039607375','9027862116'] ;
